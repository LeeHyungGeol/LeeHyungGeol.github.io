...
categories: Network
tag: [Network, HTTP, HTTP method, HTTP status, status code]
toc: true
...
> **컬렉션(Collection) : Server가 관리하는 resource directory** 
...
**3. 컬렉션(Collection)**
- **Server가 관리하는 resource directory**
- Server resource의 URI를 생성하고 관리
